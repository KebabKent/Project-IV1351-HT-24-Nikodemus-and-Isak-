...
('2024-11-24 12:00:00', '2024-11-24 18:00:00', 1, 4),
('2024-11-25 11:00:00', '2024-11-25 15:00:00', 1, 5);
...
INSERT INTO student_contact_person (contact_person_id, students_id) VALUES
(1, 1), (2, 2), (2, 3), (3, 3);
...
INSERT INTO student_expertise (students_id, instrument_expertise_id) VALUES
(1, 1), (1, 2),
(2, 3), (2, 4),
(3, 7);

-- Insert data into rented_instrument
INSERT INTO rented_instrument (students_id, instrument_id, rent_date, return_by, time_of_return) VALUES
...
INSERT INTO individual_lesson (students_id, instructor_id, time_slot_id, price_Scheme_id) VALUES
(1, 1, 1, 1),
(3, 3, 2, 2);
...
INSERT INTO sibling (students_id, students_id_0) VALUES
(2, 3);
